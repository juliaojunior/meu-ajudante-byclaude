...
}: IcProps & { children: React.ReactNode }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IcChevronRight = (p: IcProps) => (
  <Ic {...p}><path d="M9 18l6-6-6-6" /></Ic>
);
export const IcPill = (p: IcProps) => (
  <Ic {...p}>
    <path d="M10.5 20.5a4.95 4.95 0 1 1-7-7l10-10a4.95 4.95 0 1 1 7 7l-10 10z" />
    <path d="M8.5 8.5l7 7" />
  </Ic>
);
export const IcCamera = (p: IcProps) => (
  <Ic {...p}>
...
export const IcBellOff = (p: IcProps) => (
  <Ic {...p}>
    <path d="M13.73 21a2 2 0 0 1-3.46 0" />
...
export const IcUtensils = (p: IcProps) => (
  <Ic {...p}>
...
export const IcCalendar = (p: IcProps) => (
  <Ic {...p}>
    <rect x="3" y="4" width="18" height="18" rx="2" />
    <path d="M16 2v4M8 2v4M3 10h18" />
  </Ic>
);
export const IcDroplet = (p: IcProps) => (
  <Ic {...p}><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" /></Ic>
);
...
export const IcVolume = (p: IcProps) => (
  <Ic {...p}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
    <path d="M15.54 8.46a5 5 0 0 1 0 7.07M19.07 4.93a10 10 0 0 1 0 14.14" />
  </Ic>
);
export const IcHeart = (p: IcProps) => (
  <Ic {...p}>
